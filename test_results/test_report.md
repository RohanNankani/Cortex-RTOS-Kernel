...
## test0
Compilation sanity check — calls osKernelInit, k_mem_init, and printf.
...
## test1
Cooperative multitasking still works — several tasks created using osCreateTask, which call osYield (after at least 1ms of execution time but before its deadline), will take turns in a Round Robin fashion
...
created task with tid-1, stack_high=0x20007420
created task with tid-2, stack_high=0x20008430
created task with tid-3, stack_high=0x20009440
created task with tid-4, stack_high=0x2000a450
created task with tid-5, stack_high=0x2000b460
created task with tid-6, stack_high=0x2000c470
created task with tid-7, stack_high=0x2000d480
created task with tid-8, stack_high=0x2000e490
created task with tid-9, stack_high=0x2000f4a0
created task with tid-10, stack_high=0x200104b0
created task with tid-11, stack_high=0x200114c0
created task with tid-12, stack_high=0x200124d0
created task with tid-13, stack_high=0x200134e0
PASS: osCreateTask failed (expected)
...
task-12
task-13
stack_high of exiting task: 0x20008430
task exiting...
creating new task
stack_high of newly created task: 0x20008430
PASS: task stack freed & reused
...
A started 
Resume1 delta time =4016 us
Resume2 delta time =4005 us
Resume3 delta time =3999 us
Resume4 delta time =4000 us
Resume5 delta time =3999 us
Resume6 delta time =4000 us
Resume7 delta time =3999 us
Resume8 delta time =4000 us
Resume9 delta time =3999 us
...
## test6
Multiple tasks can run periodically via osPeriodYield
...
## test9
Robustness -- the multi-periodic test runs continuously without glitches, for 500 iterations
...
## test10
Test10 Timing accuracy -- two tasks both execute on time within +-0.5ms accuracy
...
Timestamps of Task B (deadline 11ms, execution time ~7.2ms): 
B start1 =24 us, B end1 =7353 us
B start2 =11034 us, B end2 =18404 us
B start3 =22034 us, B end3 =29404 us
